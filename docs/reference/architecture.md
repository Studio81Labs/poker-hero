...
trend comparisons, and clears the warning only after a fresh run. Metadata that
does not participate in parser scoring is intentionally excluded from the hash.
