...
administration, training, and processing-job read and short mutation routes
receive focused frozen runtime containers; storage, locking, aggregation, and
persistence stay behind bootstrap-owned callables until application services
replace those concrete dependencies.
