...
route one to four ordered 1 BB limps to hero's big-blind option, a single open, one open
...
three, or four distinct, legally ordered 1 BB calls. Explicit policies cover
every possible limper pair, triple, and four-seat group; their progressively
tighter isolation boundaries adjust by stack depth, target at least 5 BB, 6 BB,
or 7 BB respectively or 1.5x the pot, and use the same effective-total cap.
Evidence retains all limper seats, their count, the named policy, adjusted
range, target, and cap.
