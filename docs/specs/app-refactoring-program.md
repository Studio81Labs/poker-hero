...
| 3    | In progress | Bootstrap isolation plus health, pipeline, history, MCP administration, training, and processing-job read, upload, short mutation, and recommendation routers landed; benchmark and backup routes stay in the bootstrap |
