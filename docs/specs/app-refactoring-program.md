...
| 3    | In progress | Bootstrap isolation plus health, pipeline, history, MCP administration, training, and processing-job read, short mutation, and recommendation routers landed; remaining route domains stay in the bootstrap |
