...
| 3    | In progress | All HTTP route domains have focused routers and runtime boundaries; shared support plus pipeline, observability, history, core jobs, and training workflow integration modules have landed, with other domains still to split |
