...
| 3    | In progress | All HTTP route domains have focused routers and runtime boundaries; shared support plus pipeline, observability, history, and core jobs integration modules have landed, with other domains still to split |
