...
| 3    | In progress | All HTTP route domains have focused routers and runtime boundaries; shared support plus pipeline and observability integration modules have landed, with route domains still to split |
