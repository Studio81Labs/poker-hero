...
| 3    | In progress | Bootstrap isolation plus health, pipeline, history, MCP administration, and training routers landed; remaining route domains stay in the bootstrap |
