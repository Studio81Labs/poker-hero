...
| 3    | In progress | Bootstrap isolation plus health, pipeline, history, MCP administration, training, benchmark, and processing-job read, upload, short mutation, and recommendation routers landed; backup routes stay in the bootstrap |
