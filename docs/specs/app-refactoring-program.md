...
| 3    | In progress | All HTTP route domains have focused routers and runtime boundaries; shared support plus pipeline, observability, history, core jobs, training workflow, benchmark, and recommendation integration modules have landed, with other domains still to split |
