...
- Number of opponents already committed at the current wager in a multiway
  facing-bet spot.
- Opponents' total current-street wager when it differs from hero's remaining
  call amount or cannot be derived from reviewed action history.
